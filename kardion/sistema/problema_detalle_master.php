...
if(isset($_POST['btncerrar'])){
    $resp = $_problemas->casoCerrado($ProblemaId);
    if($resp){
        echo $_alertas->successRedirect("Hecho","Caso cerrado exitosamente", "problema_detalle_master.php?id=$ProblemaId");
    }
}
                      ...
                      <div class='span12'>
                        <div class='row-fluid'>
                         ...
                         <div class="row-fluid">
                          ...
                          if($estado == "Activo"){
                            echo "
                            <input class='btn btn-inverse' name='btncerrar' id='btncerrar' style='margin-bottom:5px' value='Cerrar caso' type='submit'>
                            <br> <br>
                            ";
                          }
                          ?>
