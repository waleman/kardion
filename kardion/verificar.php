...
<head>
    ...
    <title>Verificar tu correo</title>
    <style>
            /*<![CDATA[*/
...
if(isset($_GET['id'])){
    ...
    $codigo = $_GET['id'];
    $usuario = new usuario;
    $resp = $usuario->activar($codigo);
    
}else{
    echo"<h1>Parece que estás perdido </h1>";
    echo"<p>Puedes regresar al login desde . <a href='login.php'>aqui</a></p>";
    exit();
}
                ...
                <table border='0' cellpadding='50' cellspacing='0' style='margin-left: auto;margin-right: auto;width:600px;text-align:center;' width='600'>
                    <tr>
                        <td align='center' valign='top'>
                            <img width="200" height="250" src="public/logos/kardion.png" style="outline:none; text-decoration:none;border:none,display:block;" width="100" />
                        </td>
                    </tr>
                </table>
            </center>
                    ...
                    <tr>
                        <td align='left' style='background: #ffffff; border: 1px solid #dce1e5;' valign='top' width=''>
                            <table border='0' cellpadding='0' cellspacing='0' width='100%'>
                                ...
                                <tr>
                                    <td align='center' valign='top'>
                                        <h4 style='color: #00acec !important'>Confirmacion de cuenta </h4>
                                    </td>
                                </tr>
                                <!-- <tr>
                                ...
                                <tr>
                                  ...
                                  <br>
                                        <h3><a href="login.php" style="color: #ffffff !important">Click para entrar al sistema</a></h3>
                                    </td>
                                </tr>
                                <tr>
                                    <td align='center' valign='top'>
                                        <p style='margin: 1em 0;'>
                                            <br>
                                            © Copyright 2001-2018 Copyright.es - Todos los Derechos Reservados 
                                        </p>
                                    </td>
                                </tr>
                            </table>
